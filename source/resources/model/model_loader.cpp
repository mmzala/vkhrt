...
std::shared_ptr<Model> ModelLoader::ProcessModel(const ModelCreation& modelCreation)
{
    ...
    ModelCreation newModelCreation = _vulkanContext->IsExtensionSupported(VK_NV_RAY_TRACING_LINEAR_SWEPT_SPHERES_EXTENSION_NAME) ? ProcessHairVoxels(modelCreation) : ProcessHairDOTS(modelCreation);
